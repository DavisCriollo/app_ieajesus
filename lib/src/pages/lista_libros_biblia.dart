...
class _ListaLibrosBibliaState extends State<ListaLibrosBiblia> {
   final TextEditingController _textSearchBibliaController = TextEditingController();
...
// print('object ${valueLibros.getlistalibrosBiblia.length}');
 if (valueLibros.getErrorLibrosBliblia == null) {
       ...
       return SingleChildScrollView(
         child: Wrap(
          children:valueLibros.getlistalibrosBibliaCompleta.entries.map((e) {
            return 
            // Text(e.key);
               Container(
                   color: Colors.white,
                    child: ListTile(
                      ...
                      onTap: (){
                         Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) =>  DetalleLibro(libro: e)),
                      );
                      },
                    ),
                  );
